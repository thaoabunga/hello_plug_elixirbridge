...
module.exports = function({ creditCards, currentTeam, user }) {
  const state = {
    ...
    country: {
      ...
      autoComplete(value) {return __async(function*(){
  ...
  function render() {return __async(function*(){
      ...
      if (typeof piece === 'string') {
        ...
        try {
          ...
          if (key === 'cardNumber') {
            ...
            const addressInfo = yield geocode({
    ...
    try {
      const res = yield creditCards.add({
