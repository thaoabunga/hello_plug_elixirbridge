  ...
  switch (subcommand) {
    ...
    case 'set-default': {
      ...
      if (cardId) {
        ...
        const confirmation = yield promptBool(label, {
          trailing: '\n'
        })
        if (!confirmation) {
          console.log('Aborted')
        ...
        const start = new Date()
        yield creditCards.setDefault(cardId)
      ...
      if (cardId) {
        ...
        if (cardId === cards.defaultCardId) {
          if (remainingCards.length === 0) {
            ...
            const cards = yield creditCards.ls()
