...
function run({ token, config: { currentTeam } }) {return __async(function*(){
  ...
  switch (subcommand) {
    case 'switch':
    case 'change': {
      yield require(resolve(__dirname, 'teams', 'switch.js'))({
        teams,
        args,
        token
      })
    ...
    case 'add':
    case 'create': {
      yield require(resolve(__dirname, 'teams', 'add.js'))({ teams, token })
      break
    }

    case 'invite': {
      yield require(resolve(__dirname, 'teams', 'invite.js'))({
        teams,
        args,
        token
      })
