...
module.exports = function({ teams, token }) {return __async(function*(){
  let slug
  let team
  let elapsed
  let stopSpinner
  ...
  const res = yield teams.edit({ id: team.id, name })
  stopSpinner()
  ...
  yield cfg.merge({ currentTeam: team })
  stopSpinner()

  yield require('./invite')({
    teams,
    args: [],
    token,
